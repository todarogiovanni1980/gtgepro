...
/**
 * prodotto Table class
 *
 * @since  1.6
 */
class TgmagTableprodotto extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'TgmagTableprodotto', array('typeAlias' => 'com_tgmag.prodotto'));
		parent::__construct('#__tgmag_prodotti', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_tgmag.prodotto.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_tgmag/access.xml',
				"/access/section[@name='prodotto']/"
			);
			$default_actions = JAccess::getAssetRules('com_tgmag.prodotto.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_tgmag.prodotto.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_tgmag');
